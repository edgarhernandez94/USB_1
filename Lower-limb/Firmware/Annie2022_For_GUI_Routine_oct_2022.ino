...
//To install potentiometer, rotate knee from -90 to 0 degrees and max the pot in that same direction; then give the pot a 180 degree turn back.
...
float Cal_values[4] = {MinPotVal, MaxPotVal, -90, 0}; // In reference to Alice2022: 65 = -90 and 405 = 0.
...
const float pwm_minimum_movement[2] = { -40.0, 50.0};//These are values for overcoming the static friction (THE FIRST VALUE MUST BE THE LOWEST, AND IT IS RELATED TO FLEXON)
